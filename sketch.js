...
function setup(){
    ...
    ball1= new Balls((displayWidth/2)-20,300,30,1);
    ball2= new Balls((displayWidth/2)-20,340,30,2)
    ball3= new Balls((displayWidth/2)-20,380,30,3)
    ball4= new Balls((displayWidth/2)-20,420,30,1)
    ball5= new Balls((displayWidth/2)-20,460,30,3)

    
    ball6= new Balls((displayWidth/2)+15,320,30,3)
    ball7= new Balls((displayWidth/2)+15,360,30,1)
    ball8= new Balls((displayWidth/2)+15,400,30,2)
    ball9= new Balls((displayWidth/2)+15,440,30,1)

    ball10= new Balls((displayWidth/2)+50,340,30,2)
    ball11= new Balls((displayWidth/2)+50,380,30,1)
    ball12= new Balls((displayWidth/2)+50,420,30,3)

    ball13= new Balls((displayWidth/2)+85,360,30,3)
    ball14= new Balls((displayWidth/2)+85,400,30,1)

    ball15= new Balls((displayWidth/2)+120,380,30,3)
...
function mouseReleased(){
    ...
    var force = p5.Vector.fromAngle(stick.body.angle);
    console.log(force);
    Body.applyForce(stick.body, stick.body.position, force);
   // Body.applyForce(stick.body, {x: mouseX, y: mouseY}, force);
    //hit.fly();
}
